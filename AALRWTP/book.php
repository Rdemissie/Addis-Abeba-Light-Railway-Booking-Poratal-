...
<body>
  <h1><center><b>Train Ticket Booking &nbsp</center></b></h1>
...
<div class="container2">
  ...
  &nbsp
   ...
   <option>Torhailoch</option>
   <option>Lideta</option>
   <option>Mexico Adebabay</option>
   <option>Legehar</option>
   <option>Stadium</option>
   <option>Bambis</option>
   <option>Urael Church</option>
   <option>Hayahulet 2</option>
   <option>Hayahulet 1</option>
   <option>Leme Hotel</option>
   <option>Megenagna</option>
   <option>Gurd Shola 2</option>
   <option>Gurd Shola 1</option>
   <option>Civil Service University</option>
   <option>CMC</option> 
   <option>Aayat</option>
   </select>
